...
export default function sitemap(): MetadataRoute.Sitemap {
  const now = new Date()
  const fixed = ["", "/services", "/cost", "/tools/cost-calculator", "/areas/ghaziabad", "/areas/greater-noida", "/areas/noida", "/areas/crossings-republik", "/projects", "/projects/contemporary-family-home", "/projects/shrishti-interior-work", "/projects/gaur-saundaryam", "/about", "/contact", "/process"]
  return [
